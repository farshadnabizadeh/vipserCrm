                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <div class="row align-items-center">
                                            <div class="col-6">
                                                <div class="dropdown">
                                                    <button class="btn btn-primary dropdown-toggle action-btn" type="button" data-toggle="dropdown"><img class="flag-img" src="{{ asset('assets/img/flags/es.png') }}"> İspanyolca <span class="caret"></span></button>
                                                    <ul class="dropdown-menu language-dropdown">
                                                        ...
                                                        <li><a href="{{ url('/definitions/reservations/download/'.$reservation->id.'?lang=en') }}" class="btn btn-primary"><img class="flag-img" src="{{ asset('assets/img/flags/de.png') }}"> Almanca</a></li>
