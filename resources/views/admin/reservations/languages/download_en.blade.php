                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <div class="row align-items-center">
                                            <div class="col-6">
                                                <div class="dropdown">
                                                    <button class="btn btn-primary dropdown-toggle action-btn" type="button" data-toggle="dropdown"><img class="flag-img" src="{{ asset('assets/img/flags/en.png') }}"> İngilizce <span class="caret"></span></button>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-9 bg-white">
                                                                    ...
                                                                    <div class="d-flex flex-row justify-content-end divTotalStatus">
                                                                        ...
                                                                        <div class="box"><p class="total-cost">{{ $total }} {{ $reservation->currency }}</p></div>
                                                                    </div>
                                                                    <div class="row">
